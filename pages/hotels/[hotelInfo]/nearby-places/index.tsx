...
// import { fetchNearbyPlaceHotelData } from "@/lib/firebase/hotelHandler";
...
// const DynamicPlaceAroundSection = dynamic(
//   () => import("@/components/hotel/Place/PlaceAround"),
//   { ssr: true },
// );
...
//   // useEffect(() => {
//   //   const hotelPlaceAround = new Worker("/workers/hotelPlaceAround-worker.js");

//   //   hotelPlaceAround.postMessage(hotelInfo);

//   //   hotelPlaceAround.onmessage = (event) => {
//   //     const data = event.data;

//   //     if (data.error) {
//   //       console.error("Error from worker:", data.error);
//   //     } else {
//   //       setHotelPlaceAround(data.nearby);
//   //     }
//   //   };

//   //   hotelPlaceAround.onerror = (error) => {
//   //     console.error("Worker error:", error);
//   //   };

//   //   return () => {
//   //     hotelPlaceAround.terminate();
//   //   };
//   // }, []);
...
//     <>
//       <CustomOverviewHead
//         metaTitle={`Nearby Places of ${props.hotelInfoDetails?.hotelData?.hotel_Name} - ${props.hotelInfoDetails?.hotelData?.hotel_City} Hotel Booking
// `}
//         metaDescription={`Visit Nearby Place to visit of ${props.hotelInfoDetails?.hotelData?.hotel_Name}. Book Now with Free Room Upgrade on Select Stays & Don't Miss Out on These Amazing Rates. 
...
//                 {`Nearby Places of ${props.hotelInfoDetails?.hotelData?.hotel_Name}`}
//               </h1>
//               <h3 className="mt-1">
...
//           <DynamicPlaceAroundSection
//             hotelPlaceAround={props.hotelInfoDetails?.nearby}
...
//   const hotelDetails = await fetchNearbyPlaceHotelData(hotel_slug);
