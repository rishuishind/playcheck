...
// import { fetchAmenitiesHotelData } from "@/lib/firebase/hotelHandler";
...
// const DynamicAmenitySection = dynamic(
//   () => import("@/components/hotel/Amenity/Amenity"),
//   { ssr: true },
// );
...
//   // useEffect(() => {
//   //   const hotelAmenityWorker = new Worker("/workers/hotelAmenity.worker.js");

//   //   hotelAmenityWorker.postMessage(hotelInfo);

//   //   hotelAmenityWorker.onmessage = (event) => {
...
//   //   hotelAmenityWorker.onerror = (error) => {
//   //     console.error("Worker error:", error);
//   //   };

//   //   return () => {
//   //     hotelAmenityWorker.terminate();
//   //   };
//   // }, []);
...
//       <CustomOverviewHead
//         metaTitle={`
//         Amenities of ${props.hotelInfoDetails?.hotelData?.hotel_Name} - ${props.hotelInfoDetails?.hotelData?.hotel_City} Hotel Booking`}
//         metaDescription={`Check all the amenities at ${props.hotelInfoDetails?.hotelData?.hotel_Name}. Book now at lowest price with free wifi, air conditioning, restaurant, early check-in & late check-out. Free Cancellation on All Stays`}
...
//                 {`Amenities of ${props.hotelInfoDetails?.hotelData?.hotel_Name}`}
//               </h1>
//               <h3 className="mt-1">
...
//           <DynamicAmenitySection
//             amenities={props.hotelInfoDetails?.amenities}
...
//   const hotelDetails = await fetchAmenitiesHotelData(hotel_slug);
