...
export default function ExploreIndiaSection() {
  const slides: Slide[] = [
    {
      id: 1,
      imageUrl: "https://images.staybook.in/website-images/new-delhi_1.webp",
      cityName: "New Delhi",
      tagLine: "Where History Meets Modernity in a Bustling Melange.",
      link: "hotels-in-new-delhi",
      colSpan: "md:col-span-5",
    },
    {
      id: 2,
      imageUrl: "https://images.staybook.in/website-images/amritsar_1.webp",
      cityName: "Amritsar",
    ...
    {
      id: 3,
      imageUrl: "https://images.staybook.in/website-images/mussoorie_1.webp",
      cityName: "Mussoorie",
    ...
    {
      id: 4,
      imageUrl: "https://images.staybook.in/website-images/jaipur_1.webp",
      cityName: "Jaipur",
    ...
    {
      id: 5,
      imageUrl: "https://images.staybook.in/website-images/agra_1.webp",
      cityName: "Agra",
    ...
    {
      id: 6,
      imageUrl: "https://images.staybook.in/website-images/shimla_1.webp",
      cityName: "Shimla",
    ...
    {
      id: 12,
      imageUrl: "https://images.staybook.in/website-images/mathura_1.webp",
      cityName: "Mathura",
    ...
    {
      id: 14,
      imageUrl: "https://images.staybook.in/website-images/pahalgam_1.webp",
      cityName: "Pahalgam",
    ...
    {
      id: 15,
      imageUrl: "https://images.staybook.in/website-images/mysore_1.webp",
      cityName: "Mysore",
    ...
    {
      id: 17,
      imageUrl: "https://images.staybook.in/website-images/jaisalmer_1.webp",
      cityName: "Jaisalmer",
