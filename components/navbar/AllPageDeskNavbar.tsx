...
export default function AllPageDeskNavbar() {
  ...
  return (
    <div
      ...
      className={`${
        isScrolled
          ? "bg-secondary text-white backdrop-blur-sm"
          : "bg-secondary text-white"
      } top-0 z-50 hidden w-full items-center justify-center lg:flex`}
    >
      <div className="wrapper h-full">
        <div className="flex w-full items-center justify-between">
          {/* brand logo */}
          <div className="flex items-center gap-x-10 pr-2">
          ...
          <div className="hidden items-center gap-x-10 font-bold tracking-wide lg:flex">
            ...
            {!userName ? (
              ...
              <div
                ...
                className="flex cursor-pointer items-center gap-1.5 whitespace-nowrap rounded-full bg-white p-1 pr-4"
              >
                {userImageUrl ? (
